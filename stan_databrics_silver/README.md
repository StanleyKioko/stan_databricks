# stan_databrics_silver

This folder defines all source code for the 'stan_databrics_silver' pipeline:
...
* Take a look at the sample under "sample_users_stan_databrics_silver.py" to get familiar with the syntax.
